        ...
        String formattedDateTime = currentDateTime.format(formatter);
	        ...
	        try {    
	            ...
	            if (rs.next()) {
	                ...
	                out.print("<h3 class='card-title text-primary text-center'>Return Book Details</h3>");
	                ...
	                String insert = "update getbooks set returntime=? where bookid=? and userid=?";
	                ...
	                if (r > 0) {
	                    out.print("<p class='text-success'><b>Book Return Successfully!</b></p>");
	                } else {
	                    out.print("<p class='text-danger'>Could not Return book.</p>");
	                }
	        ...
	        out.print("<a href='returnBook.html' class='btn btn-warning'>Return Another Book</a>");
